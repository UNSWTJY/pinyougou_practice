            ...
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
                        <span class="jqzoom">
                            <#if (imageList?size>0)>
                            <img height="400px" width="400px" jqimg="${imageList[0].url}" src="${imageList[0].url}"/>
                            </#if>
                        </span>
                    </div>
                    <!--下方的缩略图-->
                        ...
                        <div class="items">
                            <ul>
                                <#list imageList as item>
                                    <li><img height="400px" width="400px" src="${item.url}" bimg="${item.url}"
                ...
                <div class="clearfix choose">
                    <div id="specification" class="summary-wrap clearfix">
                        ...
                        <#list specificationList as spec>
                            ...
                            <dd>
                                <a href="javascript:;" class="{{isSelect('${spec.name}','${item}')?'selected':''}}"
                                   ng-click="selectSpecification('${spec.name}','${item}')">${item}<span title="点击取消选择">&nbsp;</span></a>
                            </dd>
                            </#list>
                            </dl>
                        </#list>
